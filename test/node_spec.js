...
describe('bitbucket node', function () {
    ...
    it('should be loaded', function (done) {
        var flow = [{ id: "n1", type: "bitbucket", name: "bitbucket" }];
        helper.load(node, flow, function () {
            var n1 = helper.getNode("n1");
            n1.should.have.property('name', 'bitbucket');
            done();
        });
    });
    ...
    it('should have payload', function (done) {
        var flow = [
            { id: "n1", type: "bitbucket", name: "bitbucket", wires: [["n2"]] },
            { id: "n2", type: "helper" }
        ];
        helper.load(node, flow, function () {
